...
export const show = createAsyncThunk('backend/manager/show', async (params: { role: string, resource: string, id: number }) => await backendAPI.show(params)(params.id))
...
export const patch = createAsyncThunk('backend/manager/patch', async (params: { role: string, resource: string, id: number | string, data: any }) => await backendAPI.patch(params)(params.id, params.data))
export const _delete = createAsyncThunk('backend/manager/delete', async (params: { role: string, resource: string, id: number }) => await backendAPI.delete(params)(params.id))
